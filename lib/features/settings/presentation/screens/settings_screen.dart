...
class _SettingsScreenState extends ConsumerState<SettingsScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      final unsearchKey = ref.read(unsearchApiKeyProvider);
      _claudeKeyController.text = claudeKey;
      _exaKeyController.text = exaKey;
      _unsearchKeyController.text = unsearchKey;
    });
  }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            _ApiKeyField(
              label: 'UnSearch API Key (${l10n.optional})',
              hint: 'unsearch-...',
              ...
              onSave: (key) {
                ref.read(unsearchApiKeyProvider.notifier).setKey(key);
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('UnSearch API Key saved')),
                );
              },
